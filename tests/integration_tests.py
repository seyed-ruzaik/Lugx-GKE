...
def test_order_service_get():
    ...
    """
    try:
        res = requests.get("http://127.0.0.1:5001/orders")
...
def test_order_service_post():
    ...
    try:
        ...
        res = requests.post("http://127.0.0.1:5001/place-order", json=payload)
...
def test_game_service_get():
    ...
    """
    try:
        res = requests.get("http://127.0.0.1:5000/games")
        assert res.status_code == 200
...
def test_game_service_post():
    ...
    try:
        ...
        res = requests.post("http://127.0.0.1:5000/add-game", json=payload)
        assert res.status_code == 201
...
def test_analytics_service():
    ...
    try:
        ...
        res = requests.post("http://127.0.0.1:5002/track", json=payload)
